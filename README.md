...
```
Examples of proportion table files can be found from the folder *data*, see for example *proportion_table_test_data_diff0.txt*. The proportion table should contain cytosines from one chromosome only and be sorted based on the genomic location of the cytosines. If available, the experimental parameters bisulfite conversion efficiency, incorrect bisulfite conversion efficiency and sequencing error rates should also be provided to the script.
