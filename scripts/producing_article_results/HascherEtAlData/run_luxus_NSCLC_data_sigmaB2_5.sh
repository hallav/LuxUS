...
#SBATCH --job-name=LuxUS_for_NSCLC_data_sigmaB2_5
...
INPUT_FOLDER=/scratch/work/hallav1/LuxUS/ROC/data/NSCLC/preanalysis_sigmaB2_5/chr"$CHR"
OUTPUT_FOLDER=/scratch/work/hallav1/LuxUS/ROC/results/NSCLC/sigmaB2_5/chr"$CHR"
OUTPUT_FILE=NSCLC_data_chr"$CHR"_BF_sigmaB2_5.txt
TIMEFILE="$OUTPUT_FOLDER"/computation_times_chr"$CHR"_sigmaB2_5.txt
