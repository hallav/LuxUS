...
WINDOW=$(sed ''"$SLURM_ARRAY_TASK_ID"'q;d' "$INPUTFOLDER"/random_indices_chr22_PValAboveLimit.txt)
echo $WINDOW

SCRIPTFOLDER=/path/to/scripts
OUTPUTFOLDER=/path/to/output/folder
OUTPUTFILE=LuxUS_BFs_Hansen_data_chr22_random_indices_PValAboveLimit.txt
TIMEFILE=/path/to/output/folder/LuxUS_computation_times_chr22_PValAboveLimit.txt
...
SIGMAR2_FILE="$OUTPUTFOLDER"/sample_means_sigmaR2_chr22_PValAboveLimit.txt
SIGMAC2_FILE="$OUTPUTFOLDER"/sample_means_sigmaC2_chr22_PValAboveLimit.txt
SIGMAE2_FILE="$OUTPUTFOLDER"/sample_means_sigmaE2_chr22_PValAboveLimit.txt
