...
INPUT_FILE=proportion_table_HebestreitEtAl_nonDMR_only_wLocation.txt
INPUT_FOLDER=/path/to/HebestreitEtAl/data
OUTPUT_FOLDER=/path/to/output/folder
DESIGN_MATRIX=/path/to/HebestreotEtAl/data/design_matrix.txt
MEANCOVFILE=/path/to/output/folder/mean_coverage_nonDMRs.txt
CYTNFILE=/path/to/output/folder/number_of_cytosines_in_window_nonDMRs.txt
