...
WINDOW=$(sed ''"$SLURM_ARRAY_TASK_ID"'q;d' "$INPUTFOLDER"/random_indices_chr21.txt)
echo $WINDOW

SCRIPTFOLDER=/path/to/scripts
OUTPUTFOLDER=/path/to/output/folder
OUTPUTFILE=LuxUS_BFs_Hansen_data_chr21.txt
TIMEFILE=/path/to/output/folder/LuxUS_computation_times_chr21.txt
...
SIGMAR2_FILE="$OUTPUTFOLDER"/sample_means_sigmaR2_chr21.txt
SIGMAC2_FILE="$OUTPUTFOLDER"/sample_means_sigmaC2_chr21.txt
SIGMAE2_FILE="$OUTPUTFOLDER"/sample_means_sigmaE2_chr21.txt
