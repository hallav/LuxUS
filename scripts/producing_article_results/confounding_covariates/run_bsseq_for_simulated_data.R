#This script is for running the bsseq tool for multiple simulated data sets 
...
#4: Number of columns in proportion table = total number of replicates
...
columns <- columns[1:input_args[4]]
...
write.table(BS_fisher, file=paste(input_args[3],"_Fisherpvalue.txt",sep=""), row.names=FALSE, col.names=FALSE)
