#Script for making input files for LuxUS. The idea is to make windows of fixed 
#size and analyze the cytosines in that window at a time. One input file is produced per window.
...
if __name__ == '__main__':
    ...
    for k in range(0,N_replicates):
        ...
        meth_data[:,k]=BSseq_data["f%s"%(k+3+N_replicates)]*BSseq_data["f%s"%(k+3)] #MAKE THIS METH COUNTS NOT METH PERCENTAGE!
