...
if __name__ == '__main__':
    ...
    parser.add_argument('-m','--alpha_e',action='store',dest='alpha_e',type=float,required=False,help="Hyperparameter alpha for prior distribution of sigmaE2. If not specified, default value %s is used."%(default_alpha_e))
    parser.add_argument('-n','--beta_e',action='store',dest='beta_e',type=float,required=False,help="Hyperparameter beta for prior distribution of sigmaE2. If not specified, default value %s is used."%(default_beta_e))
